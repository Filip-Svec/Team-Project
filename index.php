...
<body style="background-color: rgb(173, 219, 230);">
    <div class="container">
        <div class="d-flex justify-content-center flex-column" id="backboard">
            ...
            <div id="sk" style="display: none;">
                ...
                <div class="d-flex justify-content-center flex-column" id="formBackground1">
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="mb-3">
                            <button class="btn btn-success abc"><a href="csvDBoutput.csv" download>Stiahnuť logy do CSV</a></button>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="graphShowSK" onchange="onCheckboxChanged(this.checked)">
                            <label class="form-check-label" for="graphShow"> Skryť graf</label><br>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="en">
                ...
                <div class="d-flex justify-content-center flex-column" id="formBackground2">
                    ...
                    <div class="d-flex justify-content-center">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="graphShowEN" onchange="onCheckboxChanged(this.checked)">
                            <label class="form-check-label" for="graphShow"> Hide graph</label><br>
                        </div>
                    </div>
        ...
        <script>
            ...
            function onCheckboxChanged(checked) {
                if (checked)
                    $("#hiddenRow").fadeOut(100, 'linear');

                else $("#hiddenRow").fadeIn(400, 'linear');
            }
